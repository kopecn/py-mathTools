...
class TestQuaternionConstruction(unittest.TestCase):
    ...
    def test_from_components_identity(self):
    ...
    def test_from_components_general(self):
    ...
    def test_from_components_default(self):
    ...
    def test_from_axis_angle_unnormalized(self):
    ...
    def test_from_vector_part(self):
...
class TestQuaternionUnaryOperations(unittest.TestCase):
    ...
    def test_inverse_times_quaternion(self):
    ...
    def test_normalized_general(self):
...
class TestRotationMatrixConversions(unittest.TestCase):
    ...
    def test_to_rotation_matrix_90z(self):
...
class TestRotationVectorConversions(unittest.TestCase):
    ...
    def test_to_rotation_vector_identity(self):
    ...
    def test_to_rotation_vector_90z(self):
    ...
    def test_from_rotation_vector_identity(self):
    ...
    def test_from_rotation_vector_general(self):
    ...
    def test_roundtrip_rotation_vector(self):
...
class TestEulerAngleConversions(unittest.TestCase):
    ...
    def test_to_euler_angles_identity(self):
...
class TestVectorOperations(unittest.TestCase):
    ...
    def test_rotate_vector_90z(self):
    ...
    def test_rotate_vector_180x(self):
    ...
    def test_rotate_vector_general(self):
...
class TestSLERP(unittest.TestCase):
    ...
    def test_slerp_unit_preservation(self):
    ...
    def test_slerp_smooth_interpolation(self):
...
class TestArrayConversions(unittest.TestCase):
    ...
    def test_as_float_array_shape(self):
...
class TestQuaternionSerialization(unittest.TestCase):
    ...
    def test_from_dict_general(self):
    ...
    def test_from_dict_with_integers(self):
    ...
    def test_roundtrip_serialization_identity(self):
    ...
    def test_roundtrip_serialization_general(self):
    ...
    def test_roundtrip_serialization_rotation(self):
    ...
    def test_dict_modification_doesnt_affect_quaternion(self):
